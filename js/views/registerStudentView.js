...
document.querySelector("#btn-registerStudent").addEventListener('click', event => {
    ...
    const password = document.getElementById('reg-password-student').value
    ...
    const student = addStudent(id, name, email, password, grade, EEcontact, incapacity, gender, dateOfBirth, locality, disciplines, aboutMe)
